...
paths += [age_gender + p for p in ['/male_0-2', '/male_4-6', '/male_8-13', '/male_15-20', '/male_25-32', '/male_38-43', '/male_48-53', '/male_60-100']]
paths += [age_gender + p for p in ['/female_0-2', '/female_4-6', '/female_8-13', '/female_15-20', '/female_25-32', '/female_38-43', '/female_48-53', '/female_60-100']]
            ...
            if gender == 'm':
                ...
                if age is not None:
                    for src in paths:
                        ...
                        shutil.copy(src, age_gender + 'male_' + age)
            elif gender == 'f':
                for src in paths:
                ...
                if age is not None:
                    for src in paths:
                        shutil.copy(src, age_path + age)
                        shutil.copy(src, age_gender + 'female_' + age)
